...
public class EnemyImplementation implements Enemy {
	...
	public EnemyImplementation(Node[][] maze, Node startNode, GameView g) throws Exception  {
	...
	public void search(Node[][] maze, Node startNode, GameView g) {
		...
		if(i == 0) t = new Movement(maze, startNode, g); 
	}
